...
describe('fitToContext', () => {
  it('should return all messages if they fit within the budget', () => {
    const messages = {
      ...
      spatialContextMessage: { content: "spatialContextMessage" },
      temporalContextMessage: { content: "temporalContextMessage" },
      planNodeMessage: { content: "planNodeMessage" },
      externalDependencyMessage: { content: "externalDependencyMessage" },
  ...
  it('should truncate messages when they exceed the budget', () => {
    const messages = {
      systemMessage: { content: "systemMessage" },
      spatialContextMessage: { content: "a".repeat(10) },
      temporalContextMessage: { content: "b".repeat(10) },
      planNodeMessage: { content: "c".repeat(10) },
      externalDependencyMessage: { content: "d".repeat(10) },
      finalMessage: { content: "finalMessage" },
    };
  ...
  it('should handle combination of null values and exceeding messages', () => {
    const messages = {
      ...
      spatialContextMessage: { content: "a".repeat(10) },
      temporalContextMessage: null,
      planNodeMessage: { content: "b".repeat(10) },
      externalDependencyMessage: null,
      finalMessage: { content: "finalMessage" },
    };
